...
const UserTestAccess: Model<IUserTestAccessDoc> =
  mongoose.models.UserTestAccess ||
  mongoose.model<IUserTestAccessDoc>("UserTestAccess", UserTestAccessSchema);

export default UserTestAccess;
