...
export type ResponseModel = Model<IResponseDoc>;

export default (mongoose.models.Response as ResponseModel) ||
  mongoose.model<IResponseDoc, ResponseModel>("Response", ResponseSchema);
